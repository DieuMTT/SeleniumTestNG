...
public class WebUI {
    ...
    public static void clickElement(By by, int second) {
        ...
        ExtentTestManager.logMessage(Status.INFO, "Click on element " + by + " with timeout is " + second + " (second)");
    }
    ...
    public static void setText(By by, String text, int second) {
        ...
        ExtentTestManager.logMessage(Status.INFO, "Set text " + text + " on input " + by + " with timeout is " + second + " (second)");
    }
    public static void clearText(By by) {
        waitForElementVisible(by);
        getWebElement(by).clear();
        LogUtils.info("Clear text " + by);
        ExtentTestManager.logMessage(Status.INFO,"Clear text "+ by);
    }
