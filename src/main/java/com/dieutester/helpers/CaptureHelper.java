package com.dieutester.helpers;
...
//Lưu file ảnh với tên cụ thể vào đường dẫn
        try {
            FileHandler.copy(source, new File(SystemHelper.getCurrentDir()+PropertiesHelper.getValue("SCREENSHOT_PATH")+screenshotName+dateFormat.format(new Date())+".png"));
            System.out.println("Take screenshot" +screenshotName+"is successfully");
        } catch (IOException e) {
